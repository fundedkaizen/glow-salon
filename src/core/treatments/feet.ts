...
const LIBRARY = {
  ...
  massage: { id: 'massage', label: 'Foot massage', hint: 'Rub the warm oil in with long slow strokes', tool: 'fingers', gesture: 'rub', sound: 'oil', layer: 'top.oil', region: 'top.foot', radius: 92, rate: 0.16, camera: foot, reaction: 'content', wet: 0.3, complete: 0.9, clears: ['top.redness'] },
