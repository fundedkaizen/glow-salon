...
export const NAILS: TreatmentDef = {
  ...
  layers: [
    ...
    { id: 'oldPolish', kind: 'dirt', region: 'nails', seed: 'polishChips' },
    { id: 'rough', kind: 'damage', region: 'tips', seed: 'full' },
    { id: 'cuticle', kind: 'damage', region: 'cuticles', seed: 'full' },
  ...
  steps: [
    { id: 'soak', label: 'Warm soak', hint: 'Sweep the warm sponge over the hand', tool: 'sponge', gesture: 'paint', sound: 'water', layer: 'wet', region: 'hand', radius: 96, rate: 0.26, camera: hand, reaction: 'content', wet: 1, complete: 0.9 },
    { id: 'remove', label: 'Polish remover', hint: 'Rub the cotton pad over the old polish', tool: 'cottonPad', gesture: 'erase', sound: 'wipe', layer: 'oldPolish', region: 'nails', radius: 44, rate: 0.2, camera: tips, reaction: 'neutral' },
    { id: 'clip', label: 'Clip', hint: 'Tap each long nail to clip it', tool: 'clipper', gesture: 'targets', sound: 'snip', targets: 'tip', region: 'nails', camera: tips, reaction: 'neutral' },
    ...
    { id: 'nip', label: 'Nip hangnails', hint: 'Press each little hangnail to nip it', tool: 'nipper', gesture: 'targets', sound: 'snip', targets: 'hangnail', region: 'hand', camera: tips, reaction: 'flinch' },
    ...
    { id: 'scrub', label: 'Hand scrub', hint: 'Rub the sugar scrub all over the hand', tool: 'scrub', gesture: 'rub', sound: 'scrub', layer: 'scrub', region: 'hand', radius: 88, rate: 0.16, camera: hand, reaction: 'content', complete: 0.9 },
    { id: 'wipe', label: 'Warm towel', hint: 'Wipe the scrub away with the warm towel', tool: 'towel', gesture: 'erase', sound: 'wipe', layer: 'scrub', region: 'hand', radius: 100, rate: 0.22, camera: hand, reaction: 'content', wet: 0.4 },
