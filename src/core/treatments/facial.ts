...
const LIBRARY = {
  ...
  sheet: { id: 'sheet', label: 'Sheet mask', hint: 'Smooth the sheet mask on, from the middle out to the edges', tool: 'sheetMask', gesture: 'paint', sound: 'sheet', layer: 'mask', region: 'skin', radius: 104, rate: 0.42, camera: whole, reaction: 'content', wet: 0.6, complete: 0.92, tint: 0xf3f6fa },
  ...
  gold: { id: 'gold', label: 'Gold foil mask', hint: 'Lay the gold foil over the skin in soft strokes', tool: 'maskBrush', gesture: 'paint', sound: 'sheet', layer: 'mask', region: 'skin', radius: 66, rate: 0.26, camera: whole, reaction: 'content', complete: 0.93, tint: 0xe8c46a },
