...
export const DECOR_SLOTS: Record<DecorPlace, { x: number; y: number }[]> = {
  ...
  // The first floor spot stands clear of the reading lamp's arm (it reaches to about x 740).
  floor: [{ x: 772, y: 222 }, { x: 862, y: 222 }, { x: 1060, y: 222 }, { x: 600, y: 766 }, { x: 44, y: 752 }, { x: 1236, y: 764 }],
